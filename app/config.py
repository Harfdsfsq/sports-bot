...
class Settings(BaseSettings):
    ...
    self_history_context_include_state: bool = Field(default=True, validation_alias=AliasChoices("SELF_HISTORY_CONTEXT_INCLUDE_STATE"))
    ...
    self_history_sanitize_probability_enabled: bool = Field(default=True, validation_alias=AliasChoices("SELF_HISTORY_SANITIZE_PROBABILITY_ENABLED"))
    self_history_probability_percent_scale_enabled: bool = Field(default=True, validation_alias=AliasChoices("SELF_HISTORY_PROBABILITY_PERCENT_SCALE_ENABLED"))
    ...
    market_synthetic_context_enabled: bool = Field(default=True, validation_alias=AliasChoices("MARKET_SYNTHETIC_CONTEXT_ENABLED"))
    market_synthetic_context_confidence: float = Field(default=47.0, validation_alias=AliasChoices("MARKET_SYNTHETIC_CONTEXT_CONFIDENCE"))
    market_synthetic_total_default: float = Field(default=2.55, validation_alias=AliasChoices("MARKET_SYNTHETIC_TOTAL_DEFAULT"))
    market_synthetic_total_edge_scale: float = Field(default=1.35, validation_alias=AliasChoices("MARKET_SYNTHETIC_TOTAL_EDGE_SCALE"))
    market_synthetic_diff_scale: float = Field(default=1.55, validation_alias=AliasChoices("MARKET_SYNTHETIC_DIFF_SCALE"))
    market_synthetic_min_books: int = Field(default=2, validation_alias=AliasChoices("MARKET_SYNTHETIC_MIN_BOOKS"))
    ...
    force_publish_when_empty_enabled: bool = Field(default=True, validation_alias=AliasChoices("FORCE_PUBLISH_WHEN_EMPTY_ENABLED"))
    ...
    force_publish_when_empty_min_books: int = Field(default=1, validation_alias=AliasChoices("FORCE_PUBLISH_WHEN_EMPTY_MIN_BOOKS"))
    ...
    quality_emergency_min_books: int = Field(default=1, validation_alias=AliasChoices("QUALITY_EMERGENCY_MIN_BOOKS"))
    historical_segment_relief_enabled: bool = Field(default=True, validation_alias=AliasChoices("HISTORICAL_SEGMENT_RELIEF_ENABLED"))
