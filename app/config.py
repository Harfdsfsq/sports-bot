...
class Settings(BaseSettings):
    ...
    self_history_context_use_state_fallback: bool = Field(default=True, validation_alias=AliasChoices("SELF_HISTORY_CONTEXT_USE_STATE_FALLBACK"))
    self_history_context_state_max_rows: int = Field(default=160, validation_alias=AliasChoices("SELF_HISTORY_CONTEXT_STATE_MAX_ROWS"))
    self_history_context_state_weight_factor: float = Field(default=0.72, validation_alias=AliasChoices("SELF_HISTORY_CONTEXT_STATE_WEIGHT_FACTOR"))
    ...
    xg_side_sanity_guard_enabled: bool = Field(default=True, validation_alias=AliasChoices("XG_SIDE_SANITY_GUARD_ENABLED"))
    xg_side_sanity_min_diff: float = Field(default=0.52, validation_alias=AliasChoices("XG_SIDE_SANITY_MIN_DIFF"))
    xg_side_sanity_zero_line_only: bool = Field(default=True, validation_alias=AliasChoices("XG_SIDE_SANITY_ZERO_LINE_ONLY"))
    quality_single_source_context_penalty: float = Field(default=7.5, validation_alias=AliasChoices("QUALITY_SINGLE_SOURCE_CONTEXT_PENALTY"))
    quality_single_source_context_score_cap: float = Field(default=88.0, validation_alias=AliasChoices("QUALITY_SINGLE_SOURCE_CONTEXT_SCORE_CAP"))
