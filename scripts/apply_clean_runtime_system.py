...
def apply_policy() -> dict[str, Any]:
    ...
    bzz = merge_provider(providers, 'bzzoiro', {
        ...
        'env': {
            ...
            'BZZOIRO_CONTEXT_MATCH_LIMIT': '520', 'BZZOIRO_PER_RUN_MAX': '500', 'BZZOIRO_MAX_HTTP_REQUESTS_PER_RUN': '500',
    ...
    sstats = merge_provider(providers, 'sstats', {
        ...
        'env': {
            ...
            'SSTATS_PER_RUN_MAX': '120', 'SSTATS_REQUESTS_MAX_PER_RUN': '120', 'SSTATS_MAX_HTTP_REQUESTS_PER_RUN': '120', 'SSTATS_CONTEXT_MATCH_LIMIT': '260',
...
def main() -> int:
    ...
    env = {
        ...
        'SSTATS_API_VERSION': 'v1', 'SSTATS_BASE_URL': 'https://api.sstats.net', 'SSTATS_PER_RUN_MAX': '120', 'SSTATS_REQUESTS_MAX_PER_RUN': '120',
        'SSTATS_MAX_HTTP_REQUESTS_PER_RUN': '120', 'SSTATS_CONTEXT_MATCH_LIMIT': '260', 'SSTATS_DETAIL_MATCH_LIMIT': '80', 'SSTATS_FETCH_LAST_GAMES_STATS': 'true',
