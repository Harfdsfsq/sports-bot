...
def apply_policy() -> dict[str, Any]:
    ...
    odds = merge_provider(providers, 'odds_api_io', {
        ...
        'env': {
            'ENABLE_ODDS_API_IO': 'true', 'ODDS_API_IO_ENABLED': 'true', 'ODDS_API_IO_PER_RUN_MAX': '140', 'ODDS_API_IO_MAX_HTTP_REQUESTS_PER_RUN': '140',
            'ODDS_API_IO_ACCOUNT1_PER_RUN_MAX': '70', 'ODDS_API_IO_ACCOUNT2_PER_RUN_MAX': '70',
            ...
            'ODDS_API_IO_PAGE_LIMIT': '100', 'ODDS_API_IO_MAX_EVENT_PAGES_PER_SPORT': '36', 'MAX_MATCHES_FOR_ODDS_FETCH': '320',
        },
    })
    ...
    sstats = merge_provider(providers, 'sstats', {
        ...
        'env': {
            ...
            'SSTATS_PER_RUN_MAX': '150', 'SSTATS_REQUESTS_MAX_PER_RUN': '150', 'SSTATS_MAX_HTTP_REQUESTS_PER_RUN': '150', 'SSTATS_CONTEXT_MATCH_LIMIT': '0',
...
def main() -> int:
    ...
    env = {
        ...
        'ODDS_API_IO_PER_RUN_MAX': '140', 'ODDS_API_IO_MAX_HTTP_REQUESTS_PER_RUN': '140',
