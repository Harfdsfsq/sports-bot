...
- держит дневную цель 5 прогнозов через `VOLUME_POLICY_MODE=target_5`;
...
## Как получить 5 прогнозов сегодня

1. Откройте GitHub Actions.
2. Запустите workflow `run-bot` вручную.
3. Оставьте `volume_mode=target_5`.
4. Ручной запуск может добрать до 5 прогнозов за один прогон, но дневной hard cap остается 7.
