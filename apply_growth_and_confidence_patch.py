...
ODDS_API_REPLACEMENT = '''        mapping = {
        ...
        return ",".join(values or ["Bet365", "Unibet", "BetFair", "PinnacleSports"])'''
...
def patch_workflow() -> None:
    ...
    updates = {
        'ODDS_API_IO_BOOKMAKERS': 'Bet365,Unibet,Betfair,Pinnacle',
